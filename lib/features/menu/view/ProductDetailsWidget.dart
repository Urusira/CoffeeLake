...
import '../domain/usecases/GetDetailsUseCase.dart';
  ...
  class ProductDetailsState extends State<ProductDetailsWidget> {
    ...
    double getPrice(ProductData loadedProduct, double loadedProductVolume) {
      return loadedProduct.basePrice[loadedProduct.sizes.indexOf(loadedProductVolume / 1000)];
    }

    Widget getCardFooter(ProductData loadedProduct, double loadedProductVolume) {
      if (!CartRepository.contains(loadedProduct.id, loadedProductVolume)) {
        //Добавление товара
        return Row(
              ...
              onPressed: () {
                CartRepository.add(
                  CartProductData(
                    ...
                    price: getPrice(loadedProduct, loadedProductVolume),
        ...
        return Row(
          ...
          children: [
            ...
            TextButton(
              onPressed: () {
                setState(() {
                  CartRepository.remove(loadedProduct.id, loadedProductVolume);
                });
              },
            ...
            Container(
              ...
              alignment: AlignmentDirectional.center,
              child: Text(
                "${CartRepository.count(loadedProduct.id, loadedProductVolume)} шт",
                style: GoogleFonts.inknutAntiqua(
                  fontSize: 16,
            ...
            children: [
              ...
              Column(
                children: [
                            ...
                            children: [
                              ...
                              SliderTheme(
                                ...
                                child: Slider(
                                  ...
                                  divisions: getVolCount(loadedProduct, loadedProductVolume),
                  ...
                  getCardFooter(loadedProduct, loadedProductVolume),
                ],
              ),
            ],
          ),
